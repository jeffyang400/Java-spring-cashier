...
public interface StarbucksDrinkRepository extends CrudRepository<StarbucksDrink, Integer> {
    ...
    @Query("SELECT starDrink FROM StarbucksDrink starDrink WHERE starDrink.orderNumber = :orderNumber")
    List<StarbucksDrink> findByOrderNumber(@Param("orderNumber")String orderNumber) ;
